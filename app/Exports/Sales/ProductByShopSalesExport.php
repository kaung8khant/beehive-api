...
class ProductByShopSalesExport implements FromCollection, WithColumnFormatting, WithColumnWidths, WithDrawings, WithEvents, WithHeadings, WithStyles, WithTitle
{
    protected $from;
    protected $to;
    ...
    {
        return 'Product By Shop Sales report';
    }
}
